...
SpeechAction KinectReader::MapSpeechTagToAction(LPCWSTR pszSpeechTag)
{
    ...
    {
        {L"BEGIN", SpeechActionBegin},
        {L"END", SpeechActionEnd},

        {L"LEFT", SpeechActionRotateLeft},
        {L"RIGHT", SpeechActionRotateRight},
        {L"UP", SpeechActionRotateUp},
        {L"DOWN", SpeechActionRotateDown},
        {L"CLOCKWISE", SpeechActionRotateClockwise},
        {L"COUNTERCLOCKWISE", SpeechActionRotateCounterClockwise},

        {L"NEW", SpeechActionNew},
        {L"CLEAR", SpeechActionClear},

        {L"FREEZROTATION", SpeechActionFreezRotation},
        {L"CLEARROTATION", SpeechActionClearRotation},
				
        {L"FR90X", SpeechActionRotate90Right},
        {L"FRM90X", SpeechActionRotate90Left},
				
        {L"FRTOPV", SpeechActionRotateTopView},
        {L"FRRIGHTV", SpeechActionRotateRightView},
        {L"FRLEFTV", SpeechActionRotateLeftView},
        {L"FRBOTTOMV", SpeechActionRotateBottomView},
		{L"FRBACKV", SpeechActionRotateBackView},

		
        {L"CAMERAROTATEFRONTVIEW", SpeechActionCameraRotateFrontView},
		{L"CAMERAROTATEBACKVIEW", SpeechActionCameraRotateBackView},
        {L"CAMERAROTATETOPVIEW", SpeechActionCameraRotateTopView},
        {L"CAMERAROTATEBOTTOMVIEW", SpeechActionCameraRotateBottomView},
        {L"CAMERAROTATERIGHTVIEW", SpeechActionCameraRotateRightView},
        {L"CAMERAROTATELEFTVIEW", SpeechActionCameraRotateLeftView},

		
        {L"USEHAPTICS", SpeechActionUseHaptics},
        {L"USESOUND", SpeechActionUseSound},

		{L"QUIT", SpeechActionQuit},
	};
