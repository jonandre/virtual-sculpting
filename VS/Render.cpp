...
void Render::Draw( GridModel* model, KinectTool* tool, glm::mat4& view, 
...
void Render::DrawingStages(TextureMappedFont* font1, TextureMappedFont* font2, 
				  TextureMappedFont* font3)
{
	if (GetStage() == 1) // START
	{
...
void Render::DrawingBottomText( TextureMappedFont* font3)
{
